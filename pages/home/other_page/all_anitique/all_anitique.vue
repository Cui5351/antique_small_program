<template>
  <view class="container">
      <view class="head_two">
		  <view @click="back">
			<uni-icons type="left" color="black"></uni-icons>
			展览展品
		  </view>
	  </view>
	  <view class="info">
		  <view class="pic">
			  <swiper class="swiper" previous-margin="50px" @change="current_change" next-margin='50px' :indicator-dots="true" circular>
			  	<swiper-item class="flex_j_a_c" v-for="(item,index) in info.data" :key="index">
		  ...
		  <view class="description flex_j_a_c">
			  <view class="title two_size">{{info.current.name}}</view>
			  <view class="text flex_c grows">
				  <view class="born flex_j_a_c">
					  <view>
						  <view class="b">
							时期:
						  </view>&ensp;
							<view>{{info.current.date}}</view>
					  </view>
					  <view class="">
						  <view class="b">
								出土地:
						  </view>&ensp;
							<view>{{info.current.born}}</view>
					  </view>
				  </view>
				  <view class="des flex_c grows">
					  <view class="de">简介</view>
					  <view class="d">
						  &emsp;&emsp;
...
export default{
  ...
  setup(){
	...
	let static_data=[{
   src:'https://mynameisczy.cn/image/antique/antiques/青瓷双系耳壶.jpg',
   born:'荆州区王氏堰出土',
   date:'西汉时期',
   name:'青瓷双系耳壶',
...
,{
   src:'https://mynameisczy.cn/image/antique/antiques/白釉孩童枕.jpg',
   born:'荆州城出土',
   date:'北宋时期',
   name:'白釉孩童枕',
...
,{
   src:'https://mynameisczy.cn/image/antique/antiques/粉彩缠枝花卉碗.jpg',
   born:'荆州城出土',
   date:'清朝时期',
   name:'粉彩缠枝花卉碗',
...
,{
   src:'https://mynameisczy.cn/image/antique/antiques/黑釉执壶.jpg',
   born:'沙市区城隍庙出土',
   date:'北宋时期',
   name:'黑釉执壶',
...
,{
   src:'https://mynameisczy.cn/image/antique/antiques/红陶盉.jpg',
   born:'天门肖家屋脊出土',
   date:'新石器时代后石家河文化时期',
   name:'红陶盉',
  ...
  {
   src:'https://mynameisczy.cn/image/antique/antiques/虎座鸟架鼓.jpg',
   born:'湖北省荆州市',
   date:'战国时期',
   name:'虎座鸟架鼓',
...
,{
   src:'https://mynameisczy.cn/image/antique/antiques/黄地粉彩龙纹杯.jpg',
   born:'荆州城出土',
   date:'清朝时期',
   name:'黄地粉彩龙纹杯',
...
,{
   src:'https://mynameisczy.cn/image/antique/antiques/青瓷龙柄盘口壶.jpg',
   born:'荆州区江陵砖瓦厂出土',
   date:'隋朝时期',
   name:'青瓷龙柄盘口壶',
...
,{
   src:'https://mynameisczy.cn/image/antique/antiques/青瓷瓿.jpg',
   born:'荆州区王氏堰出土',
   date:'西汉时期',
   name:'青瓷瓿',
...
,{
   src:'https://mynameisczy.cn/image/antique/antiques/石牙璋.jpg',
   born:'沙市汪家屋场出土',
   date:'新石器时代后石家河文化时期',
   name:'石牙璋',
...
,{
   src:'https://mynameisczy.cn/image/antique/antiques/玉覆面.jpg',
   born:'荆州秦家山二号墓出土',
   date:'战国时期',
   name:'玉覆面',
   description:'长25厘米，宽28厘米。玉覆面，玉质青白，有沁色，共由十四块玉饰组合而成，其中额顶尖角和唇舌由碎玉废料改制。眼、颊由龙形玉片组成，雕刻工艺精细，局部有朱砂残留。其他玉饰片上有微孔，应是位穿缀所留。'
	...
	init()
	function init(){
		Object.keys(info.current).forEach(item=>{
			info.current[item]=info.data[0][item]
		})
	}
	
	function current_change({detail}){
		Object.keys(info.current).forEach(item=>{
			info.current[item]=info.data[detail.current][item]
		})
		
	}
    return{back,info,current_change}
  }
}
</script>
