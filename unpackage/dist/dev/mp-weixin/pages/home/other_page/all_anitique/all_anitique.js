...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.f($setup.info.data, (item, index, i0) => {
      return {
        a: item.src,
        b: index
      };
    }),
    d: common_vendor.o((...args) => $setup.current_change && $setup.current_change(...args)),
    e: common_vendor.t($setup.info.current.name),
    f: common_vendor.t($setup.info.current.date),
    g: common_vendor.t($setup.info.current.born),
    h: common_vendor.t($setup.info.current.description)
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-e57fb5b3"], ["__file", "C:/Users/86130/Documents/HBuilderProjects/传承非遗/pages/home/other_page/all_anitique/all_anitique.vue"]]);
